...
print("------------------------------------------------")
print("[+] Toools Created By NetroGanz")
print("[+] Use Tools Netro DDOS V3")
print("")
print("[+]Netro Attack Cybers")
print("[+]attack website ON")
print("[+]attack GTPS ON")
print("[-] NETRO || TCP || UDP || HTTP || DDOS || JETX || OVH || NTP")
print("------------------------------------------------")
